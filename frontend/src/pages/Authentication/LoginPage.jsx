        ...
        <div className="w-full max-w-[420px] bg-[#141414]/80 backdrop-blur-xl rounded-3xl border border-white/5 px-10 py-10 shadow-2xl">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-all">
              ...
              <span className="text-[24px] font-bold tracking-wide" style={{ color: 'var(--text-color)' }}>GoJapan</span>
            </Link>
          </div>

          {/* Heading */}
          <div className="text-center mb-8">
            <h1 className="text-[36px] font-bold mb-2 tracking-tight" style={{ color: 'var(--text-color)' }}>Sign In</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#1e1e1e]/50 border border-white/5 rounded-2xl px-5 py-4 text-[16px] placeholder-[#444] focus:outline-none focus:border-white/20 focus:bg-[#222] transition-all"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#1e1e1e]/50 border border-white/5 rounded-2xl px-5 py-4 pr-12 text-[16px] placeholder-[#444] focus:outline-none focus:border-white/20 focus:bg-[#222] transition-all"
                  style={{ color: 'var(--text-color)' }}
                  disabled={isLoading}
                />
                <button
          ...
          <div className="flex gap-4">
            <button 
              ...
              disabled={isLoading}
              className="flex-1 flex items-center justify-center gap-2.5 bg-[#1e1e1e]/50 border border-white/5 rounded-2xl py-4 text-[14px] font-bold hover:bg-[#252525] hover:border-white/10 transition-all group disabled:opacity-50"
              style={{ color: 'var(--text-color)' }}
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="opacity-60 group-hover:opacity-100 transition-opacity">
          ...
          <p className="text-center text-[#555] text-[14px] mt-10">
            ...
            <span 
               ...
               className="font-bold cursor-pointer hover:underline decoration-red-600 underline-offset-4 transition-all"
               style={{ color: 'var(--text-color)' }}
            >
              Sign up
            </span>
