      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12 z-10">
        <div className="w-full max-w-[420px] bg-[#141414]/80 backdrop-blur-xl rounded-3xl border border-white/5 px-10 py-10 shadow-2xl">
          ...
          <div className="flex gap-4">
            <button className="flex-1 flex items-center justify-center gap-2.5 bg-[#1e1e1e]/50 border border-white/5 rounded-2xl py-4 text-white text-[14px] font-bold hover:bg-[#252525] hover:border-white/10 transition-all group">
